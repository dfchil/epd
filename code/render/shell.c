...
void _render_shell_TR(void* data) {
  ...
  enj_color_t shell_color = shell->origin->color.primary;
...
#define SHELL_TRAIL_WIDTH 3.0f
  ...
  // enj_color_t shadow_color = shell->origin->color.primary;
  // shadow_color.a = 255;

  // terrain_t* terrain = (terrain_t*)((scene_t*)shell->origin->scene)->terrain;
  // render_strip_line(terrain->verts + shell->shadow_min_x, shell->shadow_max_x - shell->shadow_min_x + 1,
