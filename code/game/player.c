...
#define ANGLE_MAX 2.35619449
#define ANGLE_MIN 0.785398163
...
void player_initialize(int player_index, void *scene) {
  ...
  player->shoot_angle = ANGLE_MIN + (ANGLE_MAX - ANGLE_MIN) * player_index / (NUM_PLAYER_COLORS - 1); // point in different directions
  player->shoot_power = 0.0f;
