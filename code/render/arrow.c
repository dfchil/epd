...
// clang-format off
alignas(32) const static shz_vec2_t arrow_vertices[] = {
    {.x = -2.0f, .y =  0.050f},  // 0
    {.x = -2.0f, .y =  0.0f},  // 1
    {.x = +2.0f, .y =  0.0f},  // 2
    {.x = +2.0f, .y = 10.0f},  // 3
...
alignas(32) const static float zvalues[] = {
  100.0f * arrow_vertices[0].y / arrow_vertices[5].y,
  100.0f * arrow_vertices[1].y / arrow_vertices[5].y,
  100.0f * arrow_vertices[2].y / arrow_vertices[5].y,
  100.0f * arrow_vertices[3].y / arrow_vertices[5].y,
  100.0f * arrow_vertices[4].y / arrow_vertices[5].y,
  100.0f * arrow_vertices[5].y / arrow_vertices[5].y,
  100.0f * arrow_vertices[6].y / arrow_vertices[5].y,
  100.0f * arrow_vertices[7].y / arrow_vertices[5].y,
